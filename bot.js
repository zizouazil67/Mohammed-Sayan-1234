...
client.on("message", message => {
 ...
 if (message.content === "!!help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『Bot 1 | ZeusMC』 『اسم البوت』", true)
      
      .addField("『 مصمم البوت @ツ ＭＯＨＡＭＥＤＳＡＹＡＮ | xMAND | ツ#5976 』", true)
...
القسم الثالث مصمم البوت | @ツ ＭＯＨＡＭＥＤＳＡＹＡＮ | xMAND | ツ#5976 
...
!!support| القسم الثاني  الدعم الفني و المساعدة
قسم الثالث مصمم البوت @ツ ＭＯＨＡＭＥＤＳＡＹＡＮ | xMAND | ツ#5976 
