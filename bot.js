...
client.on('message', message => {
    ...
    if(message.content.includes('n3al')){
        message.delete()
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('نعال')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('يا زق')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('يا نعال')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
...
client.on("message", (message) => {
        ...
        let yumz = new Discord.RichEmbed()
                ...
                client.users.get("376226544118661130").send(yumz)
            }
});
